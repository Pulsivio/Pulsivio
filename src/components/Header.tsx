    ...
    <header className="no-print sticky top-0 z-40 w-full border-b border-slate-200/80 bg-white/95 backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/95 transition-colors">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-2 px-3 py-2 sm:px-6 sm:py-2.5">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          ...
          {/* Official Facebook Profile Link */}
          <a
            href="https://www.facebook.com/pulsivio/"
            target="_blank"
            rel="noopener noreferrer"
            id="header-facebook-link"
            className="inline-flex items-center gap-1.5 rounded-xl border border-blue-200 bg-blue-50/90 px-2 sm:px-2.5 py-1.5 text-xs sm:text-sm font-bold text-blue-700 hover:bg-blue-100 hover:border-blue-300 dark:border-blue-900/80 dark:bg-blue-950/60 dark:text-blue-300 dark:hover:bg-blue-900/60 transition-all cursor-pointer shadow-2xs active:scale-95"
            title="Oficjalny profil Pulsivio na Facebooku (facebook.com/pulsivio)"
          >
